 ...
 * @brief dma_avalon_st_sink_to_mm_master driver implementation
 */
...
/**
 * @brief This function is called by when an interrupt occurs, and
 *  calls the fc_callback or oe_callback depending on which flags
 *  are high.
 * 
 * @param context 
 */
