...
int main()
{
  ...
  camera_registerCallback(CAMERA_CALLBACK_ID_CAPTURE_COMPLETE, captureCompleteHandler, NULL);
  camera_registerCallback(CAMERA_CALLBACK_ID_CAPTURE_FAILED, captureFailedHandler, NULL);
